...
export default function FoodForm({ initial, onSubmit, isLoading, error }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">{t('product_form.name_label')}</label>
        <input
      ...
      <div>
        <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">{t('product_form.category_label')}</label>
        <select
          className={inputClass}
          value={category}
      ...
      <div>
        <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">{t('product_form.unit_label')}</label>
        <select
          className={inputClass}
          value={unit}
      ...
      <div>
        <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">{t('product_form.target_qty_label')}</label>
        <input
          className={inputClass}
          type="number"
          min="0"
