    ...
    <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2 flex-wrap">
          <h3 className="text-white text-lg font-semibold">{entry.subType ?? productName}</h3>
          {isFirst && (
            <span
              className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-green-800 text-green-200"
        ...
        <button
          ...
          className="inline-flex items-center justify-center p-2 rounded-full bg-amber-900/40 text-amber-400 hover:bg-amber-800/60 transition-colors disabled:opacity-50 -mr-1.5 -mt-1 shrink-0 ml-2"
        >
      ...
      <div className="bg-gray-700/30 -mx-4 px-4 py-3 mb-0">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
          ...
          <div>
            ...
            <p className={
              entry.expiryStatus === 'EXPIRED' ? 'text-red-400 font-medium' :
              entry.expiryStatus === 'APPROACHING' ? 'text-yellow-400 font-medium' :
              'text-white'
            }>
      ...
      {onEdit && (
        <div className="border-t border-gray-700 -mx-4 -mb-4 px-4 py-2">
          <button
